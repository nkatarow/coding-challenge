    ...
    <div className="project-description">
      ...
      <section>
        ...
        <dl>
          ...
          <dd>When one of our list items generated from the data array are selected, this function takes the value and title of that item and stores them in state. It also closes the dropdown by changing the isOpen state to false, and passes the selected value to the parent component with props.onDropdownChange.</dd>
